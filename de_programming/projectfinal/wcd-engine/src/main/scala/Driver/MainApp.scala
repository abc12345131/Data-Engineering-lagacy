...
object MainApp {
    ...
    def parseCmd(args: Array[String]): Option[SparkParams] = {
        ...
        val cmdParser = {
            import builder._
            OParser.sequence(
                programName("data_pipeline"),
                head("final_project", "0.0.1"),
                ...
                .action((x, c) => c.copy(inOptions = x))
                .text("Spark read input options"),
